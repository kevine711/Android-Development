 ...
 * {@link OnFragmentListItemsListener} interface
...
public class ListItems extends Fragment {
    ...
    public void onButtonPressed(String string) {
        if (mListener != null) {
            mListener.onFragmentListItemsInteraction(string);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentListItemsListener) {
            mListener = (OnFragmentListItemsListener) context;
        } else {
     ...
     */
    public interface OnFragmentListItemsListener {
        // TODO: Update argument type and name
        void onFragmentListItemsInteraction(String string);
    }
}
